...
public class SearchCustomerPage {
	...
	public boolean searchCustomerByEmail(String email)
	{
		...
		for(int i=1;i<=ttlRows;i++)//to iterate all the rows of the grid
		{
			...
			WebElement webElementEmail = Idriver.findElement(By.xpath("//table[@id='customers-grid']//tbody/tr[" + i  + "]/td[2]"));
...
/*
	...
	public boolean searchCustomerByName(String name)
	{
		...
		for(int i=1;i<=ttlRows;i++)//to iterate all the rows of the grid
		{
			WebElement webElementName = Idriver.findElement(By.xpath("//table[@id='customers-grid']//tbody/tr[" + i  + "]/td[3]"));
